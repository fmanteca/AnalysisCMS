...
<<<<<<< HEAD
    ...
    //No cuts
    //---------------------------------------------------------------------------
           FillLevelHistograms(Stop_00_noCuts, true);    
=======
    bool pass = true;
...
>>>>>>> 031e2dcf9eec2213ce7349cbaad7f63fcd1d1e2e
    ...
    //Has 2 Leptons                                                                                                                           
    //---------------------------------------------------------------------------     
    FillLevelHistograms(Stop_01_Has2Leptons, pass_2l);
    ...
    FillLevelHistograms(Stop_02_BVetoLoose, pass_2l);

    
    // Z Window region
    //---------------------------------------------------------------------------  
       bool pass_Zwindow = fabs(mll - Z_MASS) < 15.;
       FillLevelHistograms(Stop_03_ZWindow, pass_2l && pass_Zwindow);


    // Z peak Veto
    //---------------------------------------------------------------------------    
     pass_2l &= (_channel == em || fabs(_m2l - Z_MASS) > 15.);
    FillLevelHistograms(Stop_04_ZVeto, pass_2l);
    ...
    FillLevelHistograms(Stop_05_Ptll, pass_2l);


    // mpMET cut
    //---------------------------------------------------------------------------    
    pass_2l &= (mpmet > 20.);
    FillLevelHistograms(Stop_06_mpMet, pass_2l);
    ...
    FillLevelHistograms(Stop_07_PfMet, pass_2l);
    ...
    // FillLevelHistograms(Stop_25_20, pass_gui);
    // pass_gui &= (std_vector_lepton_pt->at(2) < 10.);
    // FillLevelHistograms(Stop_third_lepton_veto, pass_gui);
    // pass_gui &= (mll>12.);
    // FillLevelHistograms(Stop_mll, pass_gui);
    // pass_gui &= (metPfType1 > 20.);
    // FillLevelHistograms(Stop_met, pass_gui);
    // pass_gui &= (_channel == em || fabs(mll - Z_MASS) > 15.);
    // FillLevelHistograms(Stop_zveto, pass_gui);
    // pass_gui &= (mpmet > 20.);
    // FillLevelHistograms(Stop_mpmet, pass_gui);
    // pass_gui &= (ptll>30.); 
    // FillLevelHistograms(Stop_ptll, pass_gui);
    ...
    //  FillLevelHistograms(Stop_bveto, pass_gui); 
    //  if (pass_gui && _channel== mm) EventDump();
    // bool pass_0j = pass_gui;
    // pass_0j &= (njet==0);

    // FillLevelHistograms(Stop_0jet, pass_0j);
    // pass_gui &= (njet==1);
    // FillLevelHistograms(Stop_1jet, pass_gui);
    ...
    //---------------------------------------------------------------------------                             
       ...
       FillLevelHistograms(Stop_08_dphillmet, pass_2l);

       pass_2l &= (MET.Et()/_pt2l < 1.8);
       pass_2l &= (_channel == em || (MET.Et()/_pt2l > 0.76 && MET.Et()/_pt2l<1.6));
       FillLevelHistograms(Stop_09_metopt2l, pass_2l);
    ...
    // // //---------------------------------------------------------------------------                             
     ...
     FillLevelHistograms(Stop_10_ht, pass_2l);
    ...
    // FillLevelHistograms(Stop_11_TopControl, pass_tcontrol);    
    ...
    // FillLevelHistograms(Stop_12_StopControl, pass_dycontrol);        
    ...
    // FillLevelHistograms(Stop_13_IFCA_Control, pass_ifca);        
    ...
    // FillLevelHistograms(Stop_14_latino, pass_latino);
    ...
    // FillLevelHistograms(Stop_mll1, pass_mll1);        
    ...
    // FillLevelHistograms(Stop_mll2, pass_mll2);        
    ...
    // FillLevelHistograms(Stop_mll3, pass_mll3);        
    ...
    // FillLevelHistograms(Stop_mll4, pass_mll4);        
    ...
    // FillLevelHistograms(Stop_mll5, pass_mll5);        
    ...
    // FillLevelHistograms(Stop_mll6, pass_mll6);        
    ...
    // FillLevelHistograms(Stop_ptll1, pass_ptll1);        
    ...
    // FillLevelHistograms(Stop_ptll2, pass_ptll2);        
    ...
    // FillLevelHistograms(Stop_ptll3, pass_ptll3);        
    ...
    // FillLevelHistograms(Stop_ptll4, pass_ptll4);        
    ...
    // FillLevelHistograms(Stop_ptll5, pass_ptll5);        
    ...
    // FillLevelHistograms(Stop_ptll6, pass_ptll6);        
    ...
    // FillLevelHistograms(Stop_dphill1, pass_dphill1);        
    ...
    // FillLevelHistograms(Stop_dphill2, pass_dphill2);        
    ...
    // FillLevelHistograms(Stop_dphill3, pass_dphill3);
    ...
    // FillLevelHistograms(Stop_dphill4, pass_dphill4);        
    ...
    // FillLevelHistograms(Stop_dphill5, pass_dphill5);       
    ...
    // FillLevelHistograms(Stop_dphill6, pass_dphill6);        
